...
~\\[5cm]
\includegraphics[width=10cm]{../res/logo/logo_medium.png}~\\[1cm]

{ \huge \bfseries Cathode Ray Tracer \\[1.5cm] }
{\large \em Submitted in partial fulfillment of\\the requirements for the award of the degree of}\\[0.5cm]
{ \large \bfseries Bachelor of Science\\in\\Computer Science and Engineering }\\[1.5cm]
...
\includegraphics[height=0.7cm]{img/heig-vd.png}\\[0.4cm]
