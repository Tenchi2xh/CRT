...
\documentclass[a4paper, twocolumn, 10pt, twoside]{report}
...
% for non-superscript footnote numbers (in the footnote itself)
...
% for custom figures
\newcommand{\customfig}[5] {
  \begin{figure}[!htbp]
      \centering
      \includegraphics[width=0.9\columnwidth,keepaspectratio]{#1}
      \caption[#2]{#2#3 \if\relax\detokenize{#5}\relax\else{\footnotesize Image~source:~#5}\fi}
      \label{fig:#4}
  \end{figure}
}
\newcommand{\customfigB}[5] {
  \begin{figure}[!htbp]
      \centering
...
\newcommand{\customfigC}[5] {
  \begin{figure}[!htbp]
      \centering
      \includegraphics[width=0.7\columnwidth,keepaspectratio]{#1}
      \caption[#2]{#2#3 \if\relax\detokenize{#5}\relax\else{\footnotesize Image~source:~#5}\fi}
      \label{fig:#4}
  \end{figure}
}
...
% for graphs
\usepackage{tikz}
\usetikzlibrary{automata,arrows,topaths,decorations.pathreplacing, decorations.markings, patterns}
